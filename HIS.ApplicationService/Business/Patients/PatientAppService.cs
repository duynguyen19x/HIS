        ...
        public virtual async Task<PagedResultDto<PatientDto>> GetAllAsync(GetAllPatientInputDto input)
        {
            ...
            try
            {
                var filter = _hisPatientRepository.GetAll()
                    .WhereIf(!string.IsNullOrEmpty(input.CodeFilter), x => x.PatientCode == input.CodeFilter)
                    .WhereIf(!string.IsNullOrEmpty(input.NameFilter), x => x.PatientName == input.NameFilter)
                    ...
                    .WhereIf(input.EthnicFilter != null, x => x.EthnicityID == input.EthnicFilter)
                    ...
                    .WhereIf(!string.IsNullOrEmpty(input.TelFilter), x => x.PhoneNumber == input.TelFilter)
                    ...
                    .WhereIf(input.BloodTypeRhFilter != null, x => x.BloodRhTypeID == input.BloodTypeRhFilter);
