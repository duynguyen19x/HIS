...
{
    public class MedicineTypeService : BaseSerivce, IMedicineTypeService
    {
        public MedicineTypeService(HISDbContext dbContext, IConfiguration config, IMapper mapper)
        ...
        public async Task<ApiResult<MedicineTypeDto>> Create(MedicineTypeDto input)
        {
        ...
        public async Task<ApiResult<MedicineTypeDto>> Update(MedicineTypeDto input)
        {
            var result = new ApiResult<MedicineTypeDto>();
            using (var transaction = _dbContext.Database.BeginTransaction())
            {
        ...
        private async Task<ApiResult<MedicineTypeDto>> ValidSave(MedicineTypeDto input)
        {
            var result = new ApiResult<MedicineTypeDto>();
        ...
        public async Task<ApiResultList<MedicineTypeDto>> GetAll(GetAllMedicineTypeInput input)
        {
