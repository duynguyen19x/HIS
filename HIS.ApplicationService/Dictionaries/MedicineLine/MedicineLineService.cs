...
{
    public class MedicineLineService : BaseSerivce, IMedicineLineService
    {
        public MedicineLineService(HISDbContext dbContext, IConfiguration config, IMapper mapper)
        ...
        public async Task<ApiResultList<MedicineLineDto>> GetAll(GetAllMedicineLineInput input)
        {
