            ...
            try
            {
                ...
                var filter = from o in branchFilter
                             ...
                             select new BranchDto()
                             {
                                 ...
                                 ProvinceName = s4.ProvinceName,
                                 ProvinceCode = s4.ProvinceCode,
                                 DistrictID = o.DistrictID,
                                 DistrictName = s5.DistrictName,
                                 DistrictCode = s5.DistrictCode,
                                 WardID = o.WardID,
                                 WardName = s6.WardName,
                                 WardCode = s6.WardCode,
