...
namespace HIS.EntityFrameworkCore.Migrations
{
    ...
    [Migration("20230823143742_Update-DExpMestMedicines")]
    partial class UpdateDExpMestMedicines
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HIS.EntityFrameworkCore.Entities.Business.Pharmaceuticals.DExpMests.DExpMestMedicine", b =>
                {
                    ...
                    b.Property<decimal?>("ExpQuantity")
            ...
            modelBuilder.Entity("HIS.EntityFrameworkCore.Entities.Dictionaries.SGender", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Code = "KXD",
                            CreatedDate = new DateTime(2023, 8, 23, 21, 37, 41, 246, DateTimeKind.Local).AddTicks(4),
                            Inactive = false,
                            Name = "Chưa xác định",
                            SortOrder = 0
                        },
                        new
                        {
                            ...
                            Code = "NAM",
                            CreatedDate = new DateTime(2023, 8, 23, 21, 37, 41, 246, DateTimeKind.Local).AddTicks(27),
                            Inactive = false,
                            Name = "Nam",
                            SortOrder = 1
                        },
                        new
                        {
                            ...
                            Code = "NU",
                            CreatedDate = new DateTime(2023, 8, 23, 21, 37, 41, 246, DateTimeKind.Local).AddTicks(29),
                            Inactive = false,
                            Name = "Nữ",
                            SortOrder = 2
                        });
            ...
            modelBuilder.Entity("HIS.EntityFrameworkCore.Entities.Dictionaries.SPatientType", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Code = "BHYT",
                            CreatedDate = new DateTime(2023, 8, 23, 21, 37, 41, 246, DateTimeKind.Local).AddTicks(1092),
                            Inactive = false,
                            Name = "Bảo hiểm y tế",
                            SortOrder = 0
                        },
                        new
                        {
                            Id = 2,
                            Code = "VP",
                            CreatedDate = new DateTime(2023, 8, 23, 21, 37, 41, 246, DateTimeKind.Local).AddTicks(1096),
                            Inactive = false,
                            Name = "Viện phí",
                            SortOrder = 0
                        },
                        new
                        {
                            Id = 3,
                            Code = "DV",
                            CreatedDate = new DateTime(2023, 8, 23, 21, 37, 41, 246, DateTimeKind.Local).AddTicks(1097),
                            Inactive = false,
                            Name = "Dịch vụ",
                            SortOrder = 0
                        });
            ...
            modelBuilder.Entity("HIS.EntityFrameworkCore.Entities.Business.PatientRecord", b =>
                {
                    b.HasOne("HIS.EntityFrameworkCore.Entities.Dictionaries.SCareer", "SCareerFk")
                        .WithMany()
                        .HasForeignKey("CareerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("HIS.EntityFrameworkCore.Entities.Dictionaries.SCountry", "SCountryFk")
                        .WithMany()
                        .HasForeignKey("CountryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("HIS.EntityFrameworkCore.Entities.Dictionaries.SDistrict", "SDistrictFk")
                        .WithMany()
                        .HasForeignKey("DistrictId");

                    b.HasOne("HIS.EntityFrameworkCore.Entities.Dictionaries.SEthnic", "SEthnicFk")
                        .WithMany()
                        .HasForeignKey("EthnicityId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("HIS.EntityFrameworkCore.Entities.Dictionaries.SGender", "SGenderFk")
                        .WithMany()
                    ...
                    b.HasOne("HIS.EntityFrameworkCore.Entities.Dictionaries.SProvince", "SProvinceFk")
                        .WithMany()
